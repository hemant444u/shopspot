    ...
    <section class="home-banner-area mb-4">
        <div class="container-1">
            <div class="row no-gutters position-relative">
                <div class="col-lg-12 position-static order-2 order-lg-0" style="background-color:#fff;border-bottom:1px solid #ccc">
                    <div class="container-fluid">
                    <div class="category-sidebar">
                        <div class="all-category d-none">
                            <span >{{__('Categories')}}</span>
                            <a href="{{ route('categories.all') }}">
                                <span class="d-none d-lg-inline-block">{{__('See All')}} ></span>
                            </a>
                        </div>
                        <ul class="categories no-scrollbar d-flex justify-content-center">
                            <li class="d-lg-none">
                                <a href="{{ route('categories.all') }}">
                            ...
                            @foreach (\App\Category::all()->take(11) as $key => $category)
                                ...
                                <li class="category-nav-element" data-id="{{ $category->id }}">
                                    <a href="{{ route('products.category', $category->slug) }}">
                                        <img class="cat-image lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset($category->icon) }}" width="30" alt="{{ __($category->cat_name) }}">
                                        <span class="cat-name">{{ __($category->cat_name) }}</span>
                                    </a>
...
<div class="container-fluid">
    <div class="row">
                <div class="@if($num_todays_deal > 0) mb-4 col-lg-12 @else col-lg-12 @endif order-1 order-lg-0" style="padding-top:15px;">
                    <div class="container-fluid">
                                ...
                                <li @if ($key == 0) class="active" @endif>
                                    <div class="trend-category-single">
                                        <a href="{{ route('products.category', $category->slug) }}" class="d-block">
                                            <div class="name">{{ __($category->cat_name) }}</div>
                                            <div>
                ...
                <div class="col-lg-12 d-none d-lg-block">
                    <div class="flash-deal-box col-lg-12 h-100">
                        
                        <div class="flash-content c-scrollbar c-height" style="background:#fff;">
                            <div class="section-title-1  p-2 ">
                            <h3 class="heading-6 mb-0 strong-700">
                                {{ __('Todays Deal') }}
            ...
            <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                <div class="section-title-1 clearfix ">
                    ...
                    <div class="flash-deal-box float-left">
                        <div class="countdown countdown--style-1 countdown--style-1-v1 " data-countdown-date="{{ date('m/d/Y', $flash_deadl->end_date) }}" data-countdown-label="show"></div>
                    </div>
                ...
                <div class="caorusel-box arrow-round gutters-5">
                    <div class="slick-carousel" data-slick-items="6" data-slick-xl-items="5" data-slick-lg-items="2"  data-slick-md-items="3" data-slick-sm-items="2" data-slick-xs-items="2">
        ...
        <div class="container-fluid">
            <div class="row gutters-10">
                @foreach (\App\Banner::where('position', 1)->where('published', 1)->get() as $key => $banner)
                    <div class="col-4 col-lg-{{ 12/count(\App\Banner::where('position', 1)->where('published', 1)->get()) }}">
