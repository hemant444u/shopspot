            ...
            <div class="row">
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        ...
                        <li>
                            <a href="{{ route('profile') }}" class="top-bar-item">{{__('My Account')}}  @if(Auth::user()->name !== '')
                            ({{Auth::user()->name}})
                             @endif</a>
                        </li>
                         <!-- <li>
                            <a href="{{ route('user.login') }}" class="top-bar-item">Seller</a>
                        </li> -->
                        <li>
                        ...
                        @else
                        <li>
                            <a href="{{ route('sellerRegPage') }}" class="top-bar-item">Seller</a>
                        </li>
                        {{-- <li>
                            <a href="{{ route('user.login') }}" class="top-bar-item">{{__('Login')}}</a>
                        </li> --}}
                        <li>
                            <a href="javascript:void(0)" data-toggle="modal" data-target="#loginModal" class="top-bar-item">{{__('Login')}}</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" data-toggle="modal" data-target="#registerModal" class="top-bar-item">{{__('Registration')}}</a>
                        </li>
                        {{-- <li>
                            ...
                            <div class="search-box flex-grow-1 px-4">
                                <form action="{{ route('search') }}" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="form-group category-select d-none">
                ...
                <div class="row no-gutters position-relative">
                    <div class="col-lg-3 position-static">
                        <div class="category-sidebar" id="category-sidebar">
                            ...
                            <ul class="categories justify-content-center">
