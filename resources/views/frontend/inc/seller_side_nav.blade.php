              ...
              {{-- <li>
                    ...
                    {{--      <li>
                       <a href="{{route('seller.product')}}" >
                        ...
                        <li>
                            <a id="seller_details" href="javascript:void(0)" class="{{ areActiveRoutesHome(['seller.digitalproducts.upload', 'seller.digitalproducts.edit'])}}">
                                <i class="la la-diamond"></i>
                                <span class="category-name">
                                    {{__('Seller Details')}}
                                </span>
                        ...
                        <li>
                            <a href="{{route('seller.store.setting')}}" >
                                    <i class="la la-diamond"></i>
                                    <span class="category-name">
                                        {{__('Store Settings')}}
                                    </span>
                ...
                <li>
                    <a href="{{ route('seller.order') }}" class="{{ areActiveRoutesHome(['order'])}}">
                        <i class="la la-dashboard"></i>
                        <span class="category-name">
                            {{__('Order')}}
                        </span>
                ...
                @endif
                <li>
                    <a href="{{ route('seller.store.setting') }}" class="{{ areActiveRoutesHome(['shops.index'])}}">
                        <i class="la la-cog"></i>
                        <span class="category-name">
                            {{__('Store Setting')}}
                        </span>
...
<script>
$(document).ready(()=>{
$("#seller_details").click(()=>{
$("#dropdown_seller_details").toggleClass("d-none");
});
});
    </script>