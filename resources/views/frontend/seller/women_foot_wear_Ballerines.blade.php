...
.button2:hover {
        ...
        <div class="container">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
				  ...
				  <div class="form-box bg-white mt-4" id="women_Foot_Wear_Ballerines_details">
 ...
 <form id="addform" >
       ...
       <div class="row"><div class="col-md-3"><label><b>Occasion Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Occasion Type" id="women_Foot_Wear_Ballerines_Occasion" name="women_Foot_Wear_Ballerines_Occasion" required><option value="">Select Occasion Type</option><?php $exp=explode(',',$result[0]->Occasion);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>      
             <div class="row">
            <div class="col-md-3">
            <label><b>Theme :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="BallerinesTheme" id="BallerinesTheme" placeholder="Ex  Multistrap Sandals" required />
