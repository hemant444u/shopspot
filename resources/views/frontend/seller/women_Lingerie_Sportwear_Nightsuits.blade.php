    ...
    <section class="gry-bg py-4 profile">
        <div class="container">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
					...
					<div class="form-box bg-white mt-4" id="women_lingire_sportwear_Nightsuits_details">
      ...
      <div class="form-box-content p-3 ">  
         <form id="addform" >
          ...
          <div class="row">
            <div class="col-md-3">
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex 100% Cotton"required/></div></div>                
       <div class="row"><div class="col-md-3"><label><b>Length Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Length Type" id="length" name="length" required><option value="">Select Length Type</option><?php $exp=explode(',',$result[0]->Length);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
       <div class="row">
            <div class="col-md-3">
            <label><b>Neck Type :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="neck" id="neck" placeholder="Ex Square type" required/></div></div> 
        ...
        <div class="row"><div class="col-md-3"><label><b>Pattern Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Pattern Type" id="pattern" name="pattern" required><option value="">Select Pattern Type</option><?php $exp=explode(',',$result[0]->Pattern);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
          <div class="row"><div class="col-md-3"><label><b> Robe : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select  Robe"  id="robe" name="robe" required><option value="" >Select Robe</option>
