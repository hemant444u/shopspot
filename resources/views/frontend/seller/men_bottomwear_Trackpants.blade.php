       ...
       <form id="addform" >
		  ...
		  <?php	$exp1=explode(',',$result[0]->Pattern);
			...
			<option value='<?php echo $exp1[$i];?>'><?php echo $exp1[$i];?></option><?php }?></select></div></div></div> 	
						 <div class="row">
            <div class="col-md-3">
            <label><b>Theme :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="theme" id="theme" placeholder="Ex Military Style" required/>
           </div></div>
		   <div class="row">
            <div class="col-md-3">
            <label><b>Usage :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="usage" id="usage" placeholder="Ex Jogger" required/>
           </div></div>
		    	 <div class="row">
