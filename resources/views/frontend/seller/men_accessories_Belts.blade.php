    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">   
         <form id="addform" >
          ...
          <div class="row"><div class="col-md-3"><label><b> Material : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Material"  id="material" name="material" required><option value="" >Select Material</option><?php
		$exp=explode(',',$result[0]->Material);
		
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>  
            <div class="row"><div class="col-md-3"><label><b> Occasion : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Occasion"  id="occasion" name="occasion" required><option value="" >Select Occasion</option><?php
		$exp=explode(',',$result[0]->Occasion);
		
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>      
        <div class="row">
            <div class="col-md-3">
            <label><b>Size in inches :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="inches" id="inches" placeholder="Ex 12" required/>
           </div></div>      
            <div class="row">
