    ...
    <section class="gry-bg py-4 profile">
     ...
     <div class="form-box bg-white mt-4" id="women_Western_Wear_TShirts_details">
      ...
      <div class="form-box-content p-3 ">        
       ...
       <div class="row">
            <div class="col-md-3">
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex Faux Leather" required/>
           </div></div> 
