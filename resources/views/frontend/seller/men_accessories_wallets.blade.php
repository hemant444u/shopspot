    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">   
        <form id="addform" >
          ...
          <div class="row"><div class="col-md-3"><label><b> Ideal For : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Ideal For"  id="idealfor"          name="idealfor" required><option value="" >Select Ideal For</option>
		  <?php
        ...
        <div class="row">
            <div class="col-md-3">
            <label><b>Material :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3"      name="material" id="material" placeholder="Ex Genuine Leather" required/>
            </div></div>  
		
					
            <div class="row"><div class="col-md-3"><label><b> Type : </b></label></div><div class="col-md-9"><div class="mb-3">
			
					<select class="form-control mb-3 selectpicker" data-placeholder="Select Type"  id="type" name="type" required>	<?php
