 ...
 <div class="form-box bg-white mt-4" id="women_Ethnic_Wear_Kurtas_details">
      ...
      <div class="form-box-content p-3 ">
        ...
        <div class="row">
            ...
            <div class="row"><div class="col-md-3"><label><b>Lenght Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Lenght Type" id="length_type" name="length_type" required><option value="">Select Lenght Type</option><?php $exp=explode(',',$result[0]->Lenght);
        ...
        <div class="row"><div class="col-md-3"><label><b>Occasion Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Occasion Type" id="occasion" name="occasion" required><option value="">Select Occasion Type</option><?php $exp=explode(',',$result[0]->Occasion);
         ...
         <div class="row"><div class="col-md-3"><label><b>Pattern Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Pattern Type" id="pattern" name="pattern" required><option value="">Select Pattern Type</option><?php $exp=explode(',',$result[0]->Pattern);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
          <div class="row"><div class="col-md-3"><label><b>Sleeve Lenght Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Sleeve Lenght Type" id="sleeve_length" name="sleeve_length" required><option value="">Select Sleeve Lenght Type</option><?php $exp=explode(',',$result[0]->Sleeve_lenght);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
           <div class="row">
            <div class="col-md-3">
            <label><b>Theme :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="theme" id="theme" placeholder="Ex Pinks & Peaches" required/>
            </div></div>
