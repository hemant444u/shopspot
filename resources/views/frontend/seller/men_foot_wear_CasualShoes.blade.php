      ...
      <div class="form-box-content p-3 ">   
       ...
       <div class="row"><div class="col-md-3"><label><b>Occasion Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Occasion Type" id="occasion" name="occasion" required><option value="">Select Occasion Type</option><?php $exp=explode(',',$result[0]->Occasion);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>      
             <div class="row">
            <div class="col-md-3">
            <label><b>Theme :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="theme" id="theme" placeholder="Ex Ankle boots"required/>
            </div></div> 
        <div class="row"><div class="col-md-3"><label><b> Type of shoe : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Type"  id="shoes_type" name="shoes_type" required><option value="" >Select Type</option><?php $exp=explode(',',$result[0]->Type);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>  
         <div class="row">
