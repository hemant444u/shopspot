  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">  
          ...
          <div class="row">
      <div class="col-md-3">
      <label><b>Fabrics :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex Cotton" required/>
      </div></div>
      ...
      for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>  
       ...
       <div class="row"><div class="col-md-3"><label><b>Sleeve Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Sleeve Type" id="sleeves" name="sleeves" required><option value="">Select Sleeve Type</option><?php $exp=explode(',',$result[0]->Sleeve_style);
      for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>  
      <div class="row">
      <div class="col-md-3">
      <label><b>Type :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="type" id="type" placeholder="Ex Gym Vest" required/>
      </div></div>   
       <div class="row">
