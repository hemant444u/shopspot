  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">
        ...
        <div class="row">
            <div class="col-md-3">
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex Cotton"required/></div></div> 
         ...
         <div class="row">
            <div class="col-md-3">
            <label><b>Styling :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="styling" id="styling" placeholder="Ex Applique, Beads & Stones" required/>
            </div></div>   
...
<script> 
 ...
 var SubSubCatId="<?php echo $result[0]->sub_subcat_id; ?>";    
        ...
        e.preventDefault()
    $.ajax({
      url: 'addEthinicwearDressMaterial',
      type: 'post',
