    ...
    <section class="gry-bg py-4 profile">
      ...
      <form id="addform" >
	   ...
	   <div class="row">
          ...
          <div class="row"><div class="col-md-3"><label><b> Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Type"  id="type" name="type" required><option value="" >Select Type</option><option value="Flip Flops" >Flip Flops</option><option value="Slides" >Slides</option><option value="Slippers" >Slippers</option>
		</select></div></div></div> 
		   <div class="row">
