    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">   
        <form id="addform" >
          ...
          <div class="row"><div class="col-md-3"><label><b> Bag Size : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Bag Size"  id="bagsize" name="bagsize" required><option value="" >Select Bag Size</option><?php
		$exp=explode(',',$result[0]->Bag_size);
		
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>      
        <div class="row">
            <div class="col-md-3">
            <label><b>Features :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="features" id="features" placeholder="Ex Laptop Sleeve" required/>
            </div></div>  
             <div class="row">
            <div class="col-md-3">
            <label><b>Material :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="material" id="material" placeholder="Ex Canvas" required/>
            </div></div>  
             <div class="row">
            <div class="col-md-3">
            <label><b>No. of compartment :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="compartment" id="compartment" placeholder="Ex 2" required/>
            </div></div>  
            <div class="row">
