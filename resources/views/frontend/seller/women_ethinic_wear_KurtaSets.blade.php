  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">
        ...
        <div class="row">
            <div class="col-md-3">
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex Lace " required/>
            </div></div>
         <div class="row"><div class="col-md-3"><label><b>Occasion Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Occasion Type" id="occasion" name="occasion" required><option value="">Select Occasion Type</option><?php $exp=explode(',',$result[0]->Occasion);
           ...
           <div class="row"><div class="col-md-3"><label><b> Pattern Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select  Type" id="pattern" name="pattern" required><option value="">Select Pattern Type</option><?php $exp=explode(',',$result[0]->Pattern);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
         <div class="row"><div class="col-md-3"><label><b>Sleeve Lenght : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Sleeve Lenght" id="sleeve_length" name="sleeve_length" required><option value="">Select Sleeve Lenght</option><?php $exp=explode(',',$result[0]->Sleeve_lenght);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>  
            <div class="row">
            <div class="col-md-3">
            <label><b>Type :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="type" id="type" placeholder="Ex Pathani and Pant Set " required/>
            </div></div>     
        <div class="row">
