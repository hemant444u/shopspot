  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">
          ...
          <div class="row"><div class="col-md-3"><label><b> Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Type"  id="type" name="type" required><option value="" >Select Type</option><option value="Corded" >Corded</option><option value="Cordless" >Cordless</option>
		 </select></div></div></div> 
		   <div class="row">
