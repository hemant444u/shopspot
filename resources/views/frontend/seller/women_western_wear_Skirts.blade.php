  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
        <div class="container">
			...
			<div class="form-box bg-white mt-4" id="women_Western_Wear_Skirts_details">
      ...
      <div class="form-box-content p-3 ">
        ...
        <div class="row">
            <div class="col-md-3">
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex 55% Linen 45% Viscose" required/>
           </div></div>
			...
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
                     <div class="row"><div class="col-md-3"><label><b> Skirt Lenght: </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Skirt Lenght"  id="skirt_length" name="skirt_length" required><option value="" >Select Skirt Lenght</option><?php $exp=explode(',',$result[0]->Skirt_lenght);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
