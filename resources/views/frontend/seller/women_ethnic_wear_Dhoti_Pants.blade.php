    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 "><div class="form-box-title px-3 py-2">Mandatory Information</div><div class="form-box-content p-3 ">   
       <form id="addform" >
        ...
        <div class="row">
            <div class="col-md-3">
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex Cotton silk" required />
           </div></div> 
		   <div class="row">
            <div class="col-md-3">
            <label><b>Type :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="type" id="type" placeholder="Ex Jhodhpuri" required />
           </div></div>     
     <div class="row">
