...
.button2:hover {
     ...
     <div class="form-box bg-white mt-4" id="women_Western_Wear_TShirts_details">
      ...
      <div class="form-box-content p-3 ">
           <form id="addform" >
             ...
             <div class="row">
            <div class="col-md-3">
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex 55 % PU, 45% Rayon" required/>
           </div></div>   
  <div class="row"><div class="col-md-3"><label><b> Occasion : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Occasion"  id="occasion" name="occasion" required><option value="" >Select Occasion</option><?php $exp=explode(',',$result[0]->Occasion);
      for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>  
              <div class="row">
            <div class="col-md-3">
            <label><b>Pattern :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="pattern" id="pattern" placeholder="Ex Chevron" required/>
           </div></div>
      ...
      <div class="row">
            <div class="col-md-3">
            <label><b>Theme :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="theme" id="theme" placeholder="Ex Florals" required/>
           </div></div>  
