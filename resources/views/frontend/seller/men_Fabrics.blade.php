  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">   
       ...
       <div class="row"><div class="col-md-3"><label><b>Fabrics : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Fabrics" id="fabric" name="fabric" required><option value="">Select Fabrics</option><?php $exp=explode(',',$result[0]->Occasion);			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div> 
			<div class="row"><div class="col-md-3"><label><b>Pattern : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Pattern" id="pattern" name="pattern" required><option value="">Select Pattern</option><?php $exp=explode(',',$result[0]->Pattern);
...
@section('script')
    ...
    <script>
var SubSubCatId="<?php echo $result[0]->subcat_id; ?>";
