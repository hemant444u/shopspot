    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">
		   ...
		   <form id="addform" >
			...
			<div class="row">
            <div class="col-md-3">
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex Khadi cotton" required/>
           </div></div>
		...
		$exp=explode(',',$result[0]->Pattern);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
		 	 <div class="row">
            <div class="col-md-3">
            <label><b>Type :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="type" id="type" placeholder="Ex Dhoti pant" required/>
           </div></div>
            <div class="row">
