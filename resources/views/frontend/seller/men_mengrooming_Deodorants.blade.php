...
.button2:hover {
  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="row">
            <div class="col-md-3">
            <label><b>Quantity :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="quantity" id="quantity" placeholder="Ex 100 ml" required/>
            </div></div>   
