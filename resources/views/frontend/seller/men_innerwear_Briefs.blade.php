...
.button2:hover {
  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="row">
      <div class="col-md-3"> 
      <label><b>Pattern :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="pattern" id="pattern" placeholder="Ex Checkered" required/>
      </div></div> 
      <div class="row">
      <div class="col-md-3"> 
      <label><b>Type :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="type" id="type" placeholder="Ex Brief" required/>
      </div></div> 
       <div class="row">
