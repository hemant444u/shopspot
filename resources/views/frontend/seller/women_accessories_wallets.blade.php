    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">
        <form id="addform" >
         ...
         <div class="row">
            <div class="col-md-3">
            <label><b>Theme :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="theme" id="theme" placeholder="Ex Leather Wallet" required/>
            </div></div>
            <div class="row">
