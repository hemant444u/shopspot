    ...
    <section class="gry-bg py-4 profile">
        <div class="container">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
				 ...
				 <div class="form-box bg-white mt-4" id="women_Western_Wear_Dresses_details">
      ...
      <div class="form-box-content p-3 ">
         <form id="addform" >
          ...
          <div class="row"><div class="col-md-3"><label><b> Dress Lenght : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Dress Lenght"  id="dress_length" name="dress_length" required><option value="" >Select Dress Lenght</option><?php $exp=explode(',',$result[0]->Dress_lenght);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>     
        <div class="row">
            <div class="col-md-3">
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex Crepe and Georgette"required/>
           </div></div> 
           <div class="row">
            <div class="col-md-3">
            <label><b>Neck :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="neck" id="neck" placeholder="Ex Chinese Collar" required/>
           </div></div> 
			...
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div> 
            <div class="row"><div class="col-md-3"><label><b> Sleeve Lenght : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Sleeve Lenght"  id="sleeve_lenght" name="sleeve_lenght" required><option value="" >Select Sleeve Lenght</option><?php $exp=explode(',',$result[0]->Sleeve_lenght);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
              <div class="row"><div class="col-md-3"><label><b> Sleeve Style : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Sleeve Style"  id="sleeve_style" name="sleeve_style" required><option value="" >Select Sleeve Style</option><?php $exp=explode(',',$result[0]->Sleeve_style);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
