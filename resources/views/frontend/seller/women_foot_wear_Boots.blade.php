    ...
    <section class="gry-bg py-4 profile">
                ...
                <div class="col-lg-9">
                    <div class="main-content">
                        ...
                        <div class="page-title">
						  ...
						  <div class="form-box bg-white mt-4" id="women_Foot_Wear_Boots_details">
      ...
      <div class="form-box-content p-3 ">  
        <form id="addform" >
         ...
         <div class="row"><div class="col-md-3"><label><b> Heel Height : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Heel Height"  id="heel_height" name="heel_height" required><option value="" >Select Heel Height</option><?php $exp=explode(',',$result[0]->Heel_height);
       ...
       <div class="row"><div class="col-md-3"><label><b>Occasion Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Occasion Type" id="occasion" name="occasion" required><option value="">Select Occasion Type</option><?php $exp=explode(',',$result[0]->Occasion);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>      
             <div class="row">
            <div class="col-md-3">
            <label><b>Theme :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="theme" id="theme" placeholder="Ex  Ankle Straps" required/>
            </div></div>    
       <div class="row">
