  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <form id="addform" >
       ...
       <div class="row"><div class="col-md-3"><label><b>Clothing Accessoies : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Clothing Accessoies" id="clothing" name="clothing" required><option value="">Select Clothing Accessoies</option><?php $exp=explode(',',$result[0]->Type);
