  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">
          ...
          <div class="row"><div class="col-md-3"><label><b> Ideal For : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Ideal For"  id="ideal_for" name="ideal_for" required><option value="" >Select Ideal For</option>
		  <?php
