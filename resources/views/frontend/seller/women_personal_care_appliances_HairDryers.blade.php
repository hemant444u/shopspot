  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box-content p-3 ">
          ...
          <div class="row"><div class="col-md-3"><label><b> Features : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Features"  id="features" name="features" required><option value="" >Select Features</option><option value="Cool Shot" >Cool Shot</option><option value="Foldable" >Foldable</option><option value="Non-Foldable" >Non-Foldable</option>
		 </select></div></div></div> 
