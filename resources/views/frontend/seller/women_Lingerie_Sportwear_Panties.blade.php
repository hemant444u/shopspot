...
.button2:hover {
  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
      ...
      <div class="form-box bg-white mt-4" id="women_lingire_sportwear_Panties_details">
      ...
      <div class="form-box-content p-3 ">  
        ...
        <div class="row"><div class="col-md-3"><label><b>Rise : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Rise" id="rise" name="rise" required><option value="">Select Rise</option><?php $exp=explode(',',$result[0]->Rise);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div> 
