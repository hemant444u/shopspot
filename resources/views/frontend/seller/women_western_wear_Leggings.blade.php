    ...
    <section class="gry-bg py-4 profile">
        <div class="container">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
			 ...
			 <div class="form-box bg-white mt-4" id="women_Western_Wear_Leggings_details">
      ...
      <div class="form-box-content p-3 ">
        ...
        <div class="row">
            ...
            <label><b>Fabric :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="fabric" id="fabric" placeholder="Ex 100% cotton" required/>
             ...
             <div class="row"><div class="col-md-3"><label><b> Ideal For : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Ideal For"  id="ideal_for" name="ideal_for" required><option value="" >Select Ideal For</option><?php $exp=explode(',',$result[0]->Suitable_for);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>
          <div class="row"><div class="col-md-3"><label><b> Leggig Style : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Leggig Style"  id="legging_style" name="legging_style" required><option value="" >Select Leggig Style</option><?php $exp=explode(',',$result[0]->Leggig_style);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>                
