  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
                    <div class="main-content">
						...
						<div class="form-box bg-white mt-4" id="women_Watches_SmartWatch_details">
      ...
      <div class="form-box-content p-3 ">  
       ...
       <div class="row"><div class="col-md-3"><label><b>Compatible OS : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Compatible OS"  id="compatible_OS" name="compatible_OS" required><option value="" >Select Compatible OS</option><?php $exp=explode(',',$result[0]->Compatible_OS);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>   
        <div class="row"><div class="col-md-3"><label><b> Dial Shape : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Dial Shape"  id="dialShape" name="dialShape" required><option value="" >Select Dial Shape</option><?php $exp=explode(',',$result[0]->Dial_shape);
			for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>    
             <div class="row">
            <div class="col-md-3">
            <label><b>Display Type :</b></label></div><div class="col-md-9"><input type="text"  class="form-control mb-3" name="display" id="display" placeholder="Ex Retina display" required/>
            </div></div>        
