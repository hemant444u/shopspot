  ...
  border: red;
    ...
    <section class="gry-bg py-4 profile">
     ...
     <div class="form-box bg-white mt-4" id="women_Western_Wear_TShirts_details">
      ...
      for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div>      
             <div class="row"><div class="col-md-3"><label><b>Sleeves Type : </b></label></div><div class="col-md-9"><div class="mb-3"><select class="form-control mb-3 selectpicker" data-placeholder="Select Sleeves Type" id="sleeves" name="sleeves" required><option value="">Select Sleeves Type</option><?php $exp=explode(',',$result[0]->Sleeve_style);
      for($i=0;$i<count($exp);$i++){ ?><option value="<?php echo $exp[$i];?>" ><?php echo $exp[$i];?></option><?php }?></select></div></div></div> 
       <div class="row">
            <div class="col-md-3">
