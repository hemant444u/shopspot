                        ...
                        <form class="" action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Your Gender')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                        <select class="form-control  selectpicker" data-placeholder="{{__('Select your gender')}}" name="gender" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Your Mobile Number')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="{{__('Your Mobile Number')}}" name="phone" value="{{ Auth::user()->phone }}" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
