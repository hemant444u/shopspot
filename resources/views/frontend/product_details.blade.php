                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="row align-items-center">
                                <div class="sold-by col-auto">
                                    ...
                                    @if ($detailedProduct->added_by == 'seller' && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                        ...
                                        <a href="{{ route('shop.visit', $detailedProduct->user->shop) }}">{{ $detailedProduct->user->shop->name }}</a>
                                        @endif
                                    @else
                                        {{ __('Inhouse product') }}
                                    @endif
                            ...
                            <hr>
                             <div class="row no-gutters mt-4">
                                    <div class="col-2">
                                        <div class="product-description-label">{{__('Category')}}:</div>
                                    </div>
                                    <div class="col-10">
                                       <div class="product-description-label"><b><?php $cat=DB::table('categories')->where('id',$detailedProduct->category_id)->first(); echo $cat->cat_name;?> </b></div>
                                    </div>
                                </div>
                            <hr>
                                <div class="row no-gutters mt-4">
                                    <div class="col-2">
                                        <div class="product-description-label">{{__('Brand')}}:</div>
                                    </div>
                                    <div class="col-10">
                                        <div class="product-description-label">
                                            <?php $cat=DB::table('brands')->where('id',$detailedProduct->brand_id)->first(); ?>
                                           <b>{{$cat ? $cat->b_name : 'N/A'}}</b>
                                        </div>
                                    </div>
                                </div>
                            <hr>
                            ...
                            @endif
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            ...
                                            <div class="avialable-amount" style="color:red;">(<span id="available-quantity">{{ $qty }}</span> {{__('available')}})</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <hr>
                                 <div class="row no-gutters mt-4">
                                    <div class="col-2">
                                        <div class="product-description-label">{{__('MRP')}}:</div>
                                    </div>
                                    <div class="col-10">
                                       <div class="product-description-label"><b style="color:blue;"><?php  echo $detailedProduct->product_price;?> </b></div>
                                    </div>
                                </div>
                                <hr>
                                <div class="row no-gutters mt-4">
                                    <div class="col-2">
                                        <div class="product-description-label">{{__('Display Price ')}}:</div>
                                    </div>
                                    <div class="col-10">
                                       <div class="product-description-label"><b style="color:blue;"><?php  echo $detailedProduct->display_price;?> </b></div>
                                    </div>
                                </div>
                                <hr>
                                <div class="row no-gutters mt-4">
                                    <div class="col-2">
                                        <div class="product-description-label">{{__('Offer ')}}:</div>
                                    </div>
                                    <div class="col-10">
                                       <div class="product-description-label"><b style="color:blue;"><?php  echo $detailedProduct->offer;?> </b></div>
                                    </div>
                                </div>
                                <hr>
                                <div class="row no-gutters mt-4">
                                    ...
                                    <div class="col-10">
                                       <div class="product-description-label"><b style="color:blue;"><?php  echo $detailedProduct->warranty;?> </b></div>
                                    </div>
                                </div>
                                <hr>
                    ...
                    <div class="product-desc-tab bg-white">
                        <div class="tabs tabs--style-2">
                            <ul class="nav nav-tabs justify-content-center sticky-top bg-white">
                                ...
                                @endif
                                @if($detailedProduct->product_specification != null)
                                    <li class="nav-item">
                                        <a href="#tab_default_3" data-toggle="tab" class="nav-link text-uppercase strong-600">{{__('Specifications')}}</a>
                                    </li>
                                @endif
                                @if($detailedProduct->manufacture_details != null)
                                    <li class="nav-item">
                                        <a href="#tab_default_4" data-toggle="tab" class="nav-link text-uppercase strong-600">{{__('Manufacture Details')}}</a>
                                    </li>
                                @endif
                                @if($detailedProduct->pdf != null)
                                    <li class="nav-item">
                                        <a href="#tab_default_5" data-toggle="tab" class="nav-link text-uppercase strong-600">{{__('Downloads')}}</a>
                                    </li>
                                @endif
                                <li class="nav-item">
                                    <a href="#tab_default_6" data-toggle="tab" class="nav-link text-uppercase strong-600">{{__('Reviews')}}</a>
                                </li>
                            </ul>
                                  ...
                                  <div class="tab-pane" id="tab_default_3">
                                    <div class="py-2 px-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mw-100 overflow--hidden">
                                                    <?php echo $detailedProduct->product_specification; ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  <div class="tab-pane" id="tab_default_4">
                                    <div class="py-2 px-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mw-100 overflow--hidden">
                                                    <?php echo $detailedProduct->manufacture_details; ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
