    ...
    <div class="col-md-6">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <p class="text-lg text-main">Total published products in last 24 hours: <span class="text-bold">{{ $products_last24h}}</span></p>
...
@if((Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
    <div class="row">
                    ...
                    <div class="panel-title" style="letter-spacing:0px;">{{__('Order')}}</div>
    ...
    <div class="col-md-2">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <br>
                <p class="text-normal text-main">{{__('Order in 24 hours')}}</p>
                <p class="text-semibold text-3x text-main">{{ $order_reports['orders_last24h']}}</p>
                <br>
                <a href="/shopspot//admin/orders" class="btn-link">{{__('Manage Orders')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
            </div>
        </div>
    ...
    <div class="col-md-2">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Active')}}</p>
                <p class="text-semibold text-3x text-main">{{ $order_reports['active_orders']}}</p>
                <br>
                <a href="/shopspot//admin/orders" class="btn-link">{{__('Manage Orders')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-2">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Successful Delivery')}}</p>
                <p class="text-semibold text-3x text-main">{{ $order_reports['successful_orders']}}</p>
                <br>
                <a href="/shopspot//admin/orders" class="btn-link">{{__('Manage Orders')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-2">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Warranty Completion Order')}}</p>
                <p class="text-semibold text-3x text-main">{{ $order_reports['successful_orders_10days_warranty'] }}</p>
                <br>
                <a href="/shopspot//admin/orders" class="btn-link">{{__('Manage Orders')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-2">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Return Initiated in last 30 days')}}</p>
                <p class="text-semibold text-3x text-main">{{ $refundReports['return_by_customer'] }}</p>
                <br>
                <a href="/shopspot//admin/orders" class="btn-link">{{__('Manage Orders')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-2">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Final Return in last 30 days')}}</p>
                <p class="text-semibold text-3x text-main">{{ $refundReports['successful_return'] }}</p>
                <br>
                <a href="/shopspot//admin/orders" class="btn-link">{{__('Manage Orders')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
...
@if((Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
    <div class="row">
                    ...
                    <div class="panel-title">{{__('CUSTOMER')}}</div>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <br>
                <p class="text-normal text-main">{{__('Total Customer')}}</p>
                <p class="text-semibold text-3x text-main">{{\App\Models\Customer::count()}}</p>
                <br>
                <a href="/shopspot//admin/customers" class="btn-link">{{__('Manage Customers')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('New Customer')}}</p>
                <p class="text-semibold text-3x text-main">{{  $customer_reports['new_daily_registered_customers'] }}</p>
                <br>
                <a href="/shopspot//admin/customers" class="btn-link">{{__('Manage Customers')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Active Customer')}}</p>
                <p class="text-semibold text-3x text-main">{{ $customer_reports['active_customers']}}</p>
                <br>
                <a href="/shopspot//admin/customers" class="btn-link">{{__('Manage Customers')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
...
@if((Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
    <div class="row">
                    ...
                    <div class="panel-title">{{__('SELLERS')}}</div>
    ...
    <div class="col-md-2">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('New sellers')}}</p>
                <p class="text-semibold text-3x text-main">{{$seller_reports['new_daily_registered_sellers'] }}</p>
                <br>
                <a href="{{ route('sellers.index') }}" class="btn-link">{{__('Manage Sellers')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-2">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Active sellers')}}</p>
                <p class="text-semibold text-3x text-main">{{ $seller_reports['active_sellers'] }}</p>
                <br>
                <a href="{{ route('sellers.index') }}" class="btn-link">{{__('Manage Sellers')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
...
@if((Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
    <div class="row">
                    ...
                    <div class="panel-title">{{__('SELLERS TYPE')}}</div>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Gem')}}</p>
                <p class="text-semibold text-3x text-main">{{ $sellerType['gem'] }}</p>
                <br>
                <a href="{{ route('sellers.index') }}" class="btn-link">{{__('Manage Sellers')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Jewel')}}</p>
                <p class="text-semibold text-3x text-main">{{ $sellerType['jewel'] }}</p>
                <br>
                <a href="{{ route('sellers.index') }}" class="btn-link">{{__('Manage Sellers')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Stone')}}</p>
                <p class="text-semibold text-3x text-main">{{ $sellerType['stone'] }}</p>
                <br>
                <a href="{{ route('sellers.index') }}" class="btn-link">{{__('Manage Sellers')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
...
@if((Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
    <div class="row">
                    ...
                    <div class="panel-title">{{__('Ticket')}}</div>
    ...
    <div class="col-md-3">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <br>
                <p class="text-normal text-main">{{__('Total Active')}}</p>
                <p class="text-semibold text-3x text-main">{{ $ticket_reports['tickets_active']}}</p>
                <br>
                <a href="/shopspot/admin/support_ticket" class="btn-link">{{__('Manage Tickets')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
            </div>
        </div>
    ...
    <div class="col-md-3">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Raise in 24 hour')}}</p>
                <p class="text-semibold text-3x text-main">{{ $ticket_reports['tickets_last24h']}}</p>
                <br>
                <a href="/shopspot/admin/support_ticket" class="btn-link">{{__('Manage Tickets')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-3">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Resolve in 24 hour')}}</p>
                <p class="text-semibold text-3x text-main">{{ $ticket_reports['tickets_resolve_last24h']}}</p>
                <br>
                <a href="/shopspot/admin/support_ticket" class="btn-link">{{__('Manage Tickets')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
    ...
    <div class="col-md-3">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Total Resolve Ticket')}}</p>
                <p class="text-semibold text-3x text-main">{{ $ticket_reports['tickets_resolve']}}</p>
                <br>
                <a href="/shopspot/admin/support_ticket" class="btn-link">{{__('Manage Tickets')}} <i class="fa fa-long-arrow-right"></i></a>
                <br>
                <br>
...
@if((Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
    <div class="row">
                    ...
                    <div class="panel-title">{{__('REVENUE')}}</div>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <br>
                <p class="text-normal text-main">{{__('Total')}}</p>
                <p class="text-semibold text-3x text-main">{{ $revenue_reports['total_revenue']}}</p>
                <br>
                <br>
                <br>
            </div>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Withdrawal')}}</p>
                <p class="text-semibold text-3x text-main">{{ $revenue_reports['money_withdrawal'] }}</p>
                <br>
                <br>
                <br>
            </div>
     ...
     <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget">
                <br>
                <p class="text-normal text-main">{{__('Revenue Generated')}}</p>
                <p class="text-semibold text-3x text-main">{{ $revenue_reports['revenue_generate'] }}</p>
                <br>
                <br>
                <br>
            </div>
