...
<div class="container">
     ...
     <ol class="wc-setup-steps">
                ...
                <div class="wc-setup-content">
                    <div class="container">
                        <h3>Bank details</h3>
                        <form id="payment"  method="POST" action="{{ route('seller-payment-details') }}" enctype="multipart/form-data">
                        @csrf
                            <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="inputEmail4">Bank name<span class="required">*</span>
                              </label>
                              <input type="text" name="bank_name" class="form-control">
                          </div>

                          <div class="form-group col-md-6">
                              <label for="inputEmail4">Account holder name<span class="required">*</span>

                              </label>
                              <input type="text" name="bank_acc_name" class="form-control">
                          </div>
                          <div class="form-group col-md-6">
                              <label for="inputEmail4">Account number <span class="required">*</span>

                              </label>
                              <input type="text" name="bank_acc_no" class="form-control">
                          </div>
                          <div class="form-group col-md-6">
                              <label for="inputEmail4">Bank ifsc code<span class="required">*</span>
                              </label>
                              <input type="text" name="ifsc_code" class="form-control">
                          </div>
                          {{-- <div class="form-group col-md-6">
                              <label for="inputEmail4"> PayPal details
                              </label>
                          ...
                          <div class="form-group col-md-6">
                              <label for="inputEmail4">Paypal email id
                              </label>
                       ...
                       <div class="row mt-3 col-md-12">
                          <div class="col-md-6 border-right">
                            ...
                            <div class="col-md-10">
                                <input type="file" name="cheque" id="file-3" class="form-control" accept="image/*">
                            </div>
                          </div>
                      ...
                      @if ($errors->has('cheque'))
                           ...
                           @endif
                        <label for="cheque" class="add-proof"  id="cheque">Signature Upload<span class="required">*</span>
                        </label>
                        <input type="file" name="cheque" class="" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
