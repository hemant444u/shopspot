...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $new_daily_registered_customers = Customer::where('created_at', '>=', Carbon::today()->toDateString())->count();
        $customers = $customers->paginate(15);
        return view('customers.index', compact('customers', 'sort_search','new_daily_registered_customers'));
    }
