...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      //  $product->tags = implode('|',$request->tags);
        ...
        $product->product_logistick = $request->product_logistick;
        $product->product_convenience = $request->product_convenience;
        $product->tax = $request->gst;
        ...
        $product->manufacture_details = $request->manufacture;
        ...
        if(count($combinations[0]) > 0){
            ...
            foreach ($combinations as $key => $combination){
             ...
             //   $item = array();
               ...
               $var_sku=$category->cat_name.'-'.$brands->b_name.'-'.$request->name.'-'.$str.$request->unit_price.'-'.$request->current_stock;
               
                $product_stock->variant = $var_sku;
                $product_stock->price = $request['price_'.str_replace('.', '_', $str)];
                $product_stock->sku = $var_sku;
